module Wechat
  module Model::CorpUser
    ...
    included do
      ...
      has_many :sessions, class_name: 'Auth::Session', primary_key: [:userid, :suite_id, :corpid, :identity], foreign_key: [:corp_userid, :suite_id, :appid, :identity], dependent: :delete_all
